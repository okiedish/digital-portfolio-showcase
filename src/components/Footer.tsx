        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 font-body text-sm">
              ...
              <li>
                <Link to="/resume" className="text-primary-foreground/80 hover:text-gold transition-colors">
                  Resume
                </Link>
              </li>
              <li>
                <Link to="/skills" className="text-primary-foreground/80 hover:text-gold transition-colors">
                  Skills
                </Link>
              </li>
              <li>
